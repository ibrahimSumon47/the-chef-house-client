...
const ChefCard = () => {
  ...
  return (
    <div>
      <h2 className="text-4xl font-extrabold text-center py-10" style={{backgroundColor: "#273262"}}>Best <span style={{color: "#c69860"}}>Chefs</span> in Our <span style={{color: "#ffc811"}}>Chef House</span></h2>
      <div className="md:grid grid-cols-2 place-items-center place-self-auto px-14 py-5 md:px-10 bg-white">
        {chefDetailsCard.map(({id, chef_picture, chef_name, experience, bio_description, Likes}) => (
          <div key={id}>
            <div className="card lg:card-side bg-base-100 shadow-xl my-5 mx-5">
              ...
              <div className="card-body">
                ...
                <div className="">
                  ...
                  <button className="btn btn-primary mt-5 w-56">View Recipes</button>
                </div>
              </div>
            </div>
          </div>
