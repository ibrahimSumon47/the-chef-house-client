...
const FoodDetails = () => {
  ...
  useEffect(() => {
    fetch("https://the-chef-house-server-ibrahimsumon47.vercel.app/food_details")
      .then((res) => res.json())
    ...
    <div>
      ...
      <div className="md:grid grid-cols-4 place-items-center place-self-auto px-14 py-5 md:px-10 " style={{backgroundColor: "#fff3ed"}}>
        {foodDetails.map((food) => (
          <div key={food.id}>
            <div className="card card-compact md:w-96 shadow-xl my-10 font-semibold" style={{backgroundColor: "#343736"}}>
              <figure>
              ...
              <div className="card-body">
                ...
                <div className="card-actions mt-5">
                  <div className="flex gap-36 md:gap-60">
