  ...
  return (
    <div className="carousel w-full">
      ...
      <div id="slide2" className="carousel-item relative w-full">
        ...
        <div className="absolute top-1/2 md:top-3/4 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
          <div className="text-center">
            <h1 className="text-3xl font-bold text-white">Mexican Salad </h1>
            <p className="text-lg text-white mt-2">In this menu we will serving you Mexican Salad for full family</p>
            <button className="btn btn-primary mt-4 ">Click Here to Order</button>
          </div>
        </div>
      </div>
      <div id="slide3" className="carousel-item relative w-full">
        ...
        <div className="absolute top-1/2 md:top-3/4 left-1/2 transform -translate-x-1/2 -translate-y-1/2 my-auto">
          <div className="text-center">
            <h1 className="text-3xl font-bold text-white">Pizza and Burger for Lunch</h1>
            <p className="text-lg text-white mt-2">In this menu we will serve you your lunch food with Pizza and Burger</p>
            <button className="btn btn-primary mt-4">Click Here to Order</button>
          </div>
        </div>
      </div>
